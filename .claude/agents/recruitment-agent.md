...
2. Call the HRM REST API directly using `curl` (via Bash) with `X-API-Key: seongon-hrm-2024` header.
...
- Use `X-API-Key: seongon-hrm-2024` for all HRM API calls; never leak key in commit messages.
